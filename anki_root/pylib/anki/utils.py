...
def strip_html(txt: str) -> str:
    ...
    return anki_root.lang.current_i18n.strip_html(text=txt, mode=StripHtmlMode.NORMAL)
...
def strip_html_media(txt: str) -> str:
    ...
    return anki_root.lang.current_i18n.strip_html(
...
def html_to_text_line(txt: str) -> str:
    ...
    return anki_root.lang.current_i18n.html_to_text_line(
...
def version_with_build() -> str:
    from anki_root.buildinfo import buildhash, version
...
def int_version() -> int:
    ...
    from anki_root.buildinfo import version
