...
import anki.notes
from anki_root import card_rendering_pb2, hooks
...
class TemplateRenderContext:
    ...
    def from_existing_card(
        card: anki_root.cards.Card, browser: bool
    ...
    def from_card_layout(
        cls,
        note: anki_root.notes.Note,
        card: anki_root.cards.Card,
    ...
    def col(self) -> anki_root.collection.Collection:
        return self._col
    ...
    def card(self) -> anki_root.cards.Card:
    ...
    def note(self) -> anki_root.notes.Note:
        return self._note
...
# legacy
def templates_for_card(card: anki_root.cards.Card, browser: bool) -> tuple[str, str]:
