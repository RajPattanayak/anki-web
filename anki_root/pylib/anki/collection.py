...
from collections.abc import Generator, Iterable, Sequence
from typing import Any, Literal, Union, cast
from anki_root.pylib.anki._legacy import DeprecatedNamesMixin, deprecated

from anki_root import (
    ankiweb_pb2,
    card_rendering_pb2,
    collection_pb2,
    config_pb2,
...
from anki_root.sync_pb2 import SyncLoginRequest
...
class Collection(DeprecatedNamesMixin):
    ...
    ) -> anki_root.notes.DefaultsForAdding:
    ...
    def stats(self) -> anki_root.stats.CollectionStats:
