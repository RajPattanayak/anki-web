...
from anki_root import deck_config_pb2, decks_pb2
...
class DecksDictProxy:
    def __init__(self, col: anki_root.collection.Collection):
...
class DeckManager(DeprecatedNamesMixin):
    ...
    def __init__(self, col: anki_root.collection.Collection) -> None:
    ...
    def cids(self, did: DeckId, children: bool = False) -> list[anki_root.cards.CardId]:
        if not children:
    ...
    def for_card_ids(self, cids: list[anki_root.cards.CardId]) -> list[DeckId]:
    ...
    def set_deck(self, cids: list[anki_root.cards.CardId], did: DeckId) -> None:
