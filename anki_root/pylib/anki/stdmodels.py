...
import anki.models
from anki_root import notetypes_pb2
...
def _get_stock_notetype(
    col: anki_root.collection.Collection, kind: StockNotetypeKind.V
) -> anki_root.models.NotetypeDict:
...
def get_stock_notetypes(
...
) -> list[tuple[str, Callable[[anki_root.collection.Collection], anki_root.models.NotetypeDict]]]:
    out: list[
        tuple[str, Callable[[anki_root.collection.Collection], anki_root.models.NotetypeDict]]
    ] = []
    ...
    for kind in [
        ...
        def instance_getter(
            model: Any,
        ) -> Callable[[anki_root.collection.Collection], anki_root.models.NotetypeDict]:
