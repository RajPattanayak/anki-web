...
def _legacy_card_stats(
    col: anki_root.collection.Collection, card_id: anki_root.cards.CardId, include_revlog: bool
) -> str:
...
class CardStats:
    ...
    def __init__(self, col: anki_root.collection.Collection, card: anki_root.cards.Card) -> None:
        if col:
