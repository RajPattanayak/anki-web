...
import anki_root.i18n_pb2 as _pb
from anki._legacy import DeprecatedNamesMixinForModule

# public exports
TR = anki_root._fluent.LegacyTranslationEnum
...
# Qt code.
current_i18n: anki_root._backend.RustBackend | None = None
tr_legacyglobal = anki_root._backend.Translations(None)
...
def set_lang(lang: str) -> None:
    ...
    current_lang = lang
    current_i18n = anki_root._backend.RustBackend(langs=[lang])
